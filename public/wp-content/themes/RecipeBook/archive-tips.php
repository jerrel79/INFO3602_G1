              ...
              <div class="Recipes">
                      <div class="row">
                          ...
                          <div class="col-md-6">
                              ...
                              <a href="<?php the_permalink(); ?>" class="btn btn-outline-primary" id="TryRecipes" >Read More</a></br></br>
                              <span><span class="author-name">Posted by <?php the_author()?> on <?php the_time('n.j.y')?></span></span> 
                          </div>
                      </div>
                </div>
